...
public class HebbsProject5Input {
	...
	public static void main(String[] args) throws IOException {
		...
		HebbsProject5Input hp = new HebbsProject5Input();
				...
				for(int j1=j+1;j1<10;j1++){
					...
					for(int j2=j1+1;j2<10;j2++){
						...
						for(int j3=j2+1;j3<10;j3++){
							...
							out.print("\nWeight from: "+i+", "+j+", "+j1+", "+j2+", "+j3+" Correctly Classified: ");
							...
							Matrix temp2 = hp.addBias(temp1, bias);
							Matrix temp = hp.convertM(temp2);
