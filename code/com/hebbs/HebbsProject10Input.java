...
public class HebbsProject10Input {
	...
	public static void main(String[] args) throws IOException {
		...
		HebbsProject10Input hp = new HebbsProject10Input();
		...
		for(int j8=j7+1;j8<10;j8++){
			...
			for(int k=0;k<35;k++){
				...
				inputdata.set(9, k, data[j8][k]);
			}
			out.print("\nWeight From: "+i+", "+j+", "+j1+", "+j2+", "+j3+", "+j4+", "+j5+", "+j6+", "+j7+", "+j8+"  Correctly Classified: ");
			...
			Matrix temp1 = fulldata.times(weight);
			hp.printMatrix(temp1);
			System.out.println("------------");
			Matrix temp = hp.addBias(temp1, bias);
			hp.printMatrix(temp);
